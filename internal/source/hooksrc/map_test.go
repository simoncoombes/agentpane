...
const (
	capSessionStart = `{"session_id":"292ef2e2-...","transcript_path":"/Users/alex/.claude/projects/<munged-cwd>/292ef2e2-....jsonl","cwd":"<dir>","hook_event_name":"SessionStart","source":"startup"}`
